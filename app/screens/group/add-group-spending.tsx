...
type Props = NativeStackScreenProps<GroupStackParams, 'AddNewGroupSpend'>


export function AddNewGroupSpendScreen(props: Props) {
    ...
    const onSaveNote = useCallback(() => {
        AsyncStorage.getItem('token')
            ...
            (json) => {
                ...
                props.route.params.setGroupSpend((spends) => {
